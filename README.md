...
| ドキュメント | 説明 |
| :--- | :--- |
| [system-overview.md](./system-overview.md) | システム全体構成・セットアップ手順 |
| [api-spec.md](./api-spec.md) | REST API・Socket.IO イベント仕様 |
| [backend.md](./backend.md) | バックエンド設計仕様 |
| [frontend.md](./frontend.md) | フロントエンド設計仕様 |
| [rpi-client.md](./rpi-client.md) | Raspberry Pi クライアント設計仕様 |
